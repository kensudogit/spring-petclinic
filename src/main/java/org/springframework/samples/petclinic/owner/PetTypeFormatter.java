 ...
 * Starting
 * from Spring 3.0, Formatters have come as an improvement in comparison to
 * legacy
 * PropertyEditors. See the following links for more details: - The Spring ref
 * doc:
...
public class PetTypeFormatter implements Formatter<PetType> {
	...
	public PetType parse(@NonNull String text, @NonNull Locale locale) throws ParseException {
		...
		// 指定されたテキストに対応するペットタイプが見つからない場合、ParseExceptionをスローします。
